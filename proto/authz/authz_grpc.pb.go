...
const (
	Authorizer_Authorize_FullMethodName = "/pdag.authz.Authorizer/Authorize"
)
...
type AuthorizerClient interface {
	Authorize(ctx context.Context, in *HttpRequest, opts ...grpc.CallOption) (*AuthorizeResponse, error)
}
...
func (c *authorizerClient) Authorize(ctx context.Context, in *HttpRequest, opts ...grpc.CallOption) (*AuthorizeResponse, error) {
...
type AuthorizerServer interface {
	Authorize(context.Context, *HttpRequest) (*AuthorizeResponse, error)
...
func (UnimplementedAuthorizerServer) Authorize(context.Context, *HttpRequest) (*AuthorizeResponse, error) {
...
func _Authorizer_Authorize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizerServer).Authorize(ctx, req.(*HttpRequest))
	}
...
var Authorizer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pdag.authz.Authorizer",
